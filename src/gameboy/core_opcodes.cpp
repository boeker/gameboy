...
void Core::ADCrA() { uint8_t n = registers->getA(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 1; }
void Core::ADCrB() { uint8_t n = registers->getB(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 1; }
void Core::ADCrC() { uint8_t n = registers->getC(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 1; }
void Core::ADCrD() { uint8_t n = registers->getD(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 1; }
void Core::ADCrE() { uint8_t n = registers->getE(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 1; }
void Core::ADCrH() { uint8_t n = registers->getH(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 1; }
void Core::ADCrL() { uint8_t n = registers->getL(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 1; }
void Core::ADCHLM() { uint8_t n = memory->read(registers->getHL()); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 2; }
void Core::ADCn() { uint8_t n = memory->read(registers->pc++); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() + n + carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(((registers->getA() & 0x0F) + (n & 0x0F) + carry) > 0x0F); registers->setCarryFlag(res > 0xFF); registers->setA(res); lastClocks = 2; }
...
void Core::SUBn() { uint8_t n = memory->read(registers->pc++); uint8_t a = registers->getA(); registers->setA(a - n); registers->setZeroFlag(registers->getA() == 0); registers->setSubFlag(true); registers->setHalfCarryFlag((registers->getA()^n^a) & 0x10); registers->setCarryFlag((a - n) < 0); lastClocks = 2; }

void Core::SBCrA() { uint8_t n = registers->getA(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 1; }
void Core::SBCrB() { uint8_t n = registers->getB(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 1; }
void Core::SBCrC() { uint8_t n = registers->getC(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 1; }
void Core::SBCrD() { uint8_t n = registers->getD(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 1; }
void Core::SBCrE() { uint8_t n = registers->getE(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 1; }
void Core::SBCrH() { uint8_t n = registers->getH(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 1; }
void Core::SBCrL() { uint8_t n = registers->getL(); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 1; }
void Core::SBCHLM() { uint8_t n = memory->read(registers->getHL()); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 1; }
void Core::SBCn() { uint8_t n = memory->read(registers->pc++); int carry = registers->getCarryFlag() ? 1 : 0; int res = registers->getA() - n - carry; registers->setZeroFlag(((uint8_t)res) == 0); registers->setSubFlag(true); registers->setHalfCarryFlag(((registers->getA() & 0x0F) - (n & 0x0F) - carry) < 0x0); registers->setCarryFlag(res < 0x0); registers->setA(res); lastClocks = 2; }
...
void Core::CCF() { registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(!registers->getCarryFlag()); lastClocks = 1; }
...
void Core::RRCA() { uint8_t lsb = registers->getA() & 0x1; registers->setA((registers->getA() >> 1) | (lsb << 7)); registers->setZeroFlag(registers->getA() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(lsb); lastClocks = 2; }
void Core::RRCB() { uint8_t lsb = registers->getB() & 0x1; registers->setB((registers->getB() >> 1) | (lsb << 7)); registers->setZeroFlag(registers->getB() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(lsb); lastClocks = 2; }
void Core::RRCC() { uint8_t lsb = registers->getC() & 0x1; registers->setC((registers->getC() >> 1) | (lsb << 7)); registers->setZeroFlag(registers->getC() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(lsb); lastClocks = 2; }
void Core::RRCD() { uint8_t lsb = registers->getD() & 0x1; registers->setD((registers->getD() >> 1) | (lsb << 7)); registers->setZeroFlag(registers->getD() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(lsb); lastClocks = 2; }
void Core::RRCE() { uint8_t lsb = registers->getE() & 0x1; registers->setE((registers->getE() >> 1) | (lsb << 7)); registers->setZeroFlag(registers->getE() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(lsb); lastClocks = 2; }
void Core::RRCH() { uint8_t lsb = registers->getH() & 0x1; registers->setH((registers->getH() >> 1) | (lsb << 7)); registers->setZeroFlag(registers->getH() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(lsb); lastClocks = 2; }
void Core::RRCL() { uint8_t lsb = registers->getL() & 0x1; registers->setL((registers->getL() >> 1) | (lsb << 7)); registers->setZeroFlag(registers->getL() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(lsb); lastClocks = 2; }
void Core::RRCHL() { uint8_t lsb = memory->read(registers->getHL()) & 0x1; memory->write(registers->getHL(), (memory->read(registers->getHL()) >> 1) | (lsb << 7)); registers->setZeroFlag(memory->read(registers->getHL()) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); registers->setCarryFlag(lsb); lastClocks = 4; }
...
void Core::SRAA() { registers->setCarryFlag(registers->getA() & 0x01); registers->setA((registers->getA() & 0x80) | (registers->getA() >> 1)); registers->setZeroFlag(registers->getA() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); lastClocks = 2; }
void Core::SRAB() { registers->setCarryFlag(registers->getB() & 0x01); registers->setB((registers->getB() & 0x80) | (registers->getB() >> 1)); registers->setZeroFlag(registers->getB() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); lastClocks = 2; }
void Core::SRAC() { registers->setCarryFlag(registers->getC() & 0x01); registers->setC((registers->getC() & 0x80) | (registers->getC() >> 1)); registers->setZeroFlag(registers->getC() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); lastClocks = 2; }
void Core::SRAD() { registers->setCarryFlag(registers->getD() & 0x01); registers->setD((registers->getD() & 0x80) | (registers->getD() >> 1)); registers->setZeroFlag(registers->getD() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); lastClocks = 2; }
void Core::SRAE() { registers->setCarryFlag(registers->getE() & 0x01); registers->setE((registers->getE() & 0x80) | (registers->getE() >> 1)); registers->setZeroFlag(registers->getE() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); lastClocks = 2; }
void Core::SRAH() { registers->setCarryFlag(registers->getH() & 0x01); registers->setH((registers->getH() & 0x80) | (registers->getH() >> 1)); registers->setZeroFlag(registers->getH() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); lastClocks = 2; }
void Core::SRAL() { registers->setCarryFlag(registers->getL() & 0x01); registers->setL((registers->getL() & 0x80) | (registers->getL() >> 1)); registers->setZeroFlag(registers->getL() == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); lastClocks = 2; }
void Core::SRAHL() { registers->setCarryFlag(memory->read(registers->getHL()) & 0x01); memory->write(registers->getHL(), (memory->read(registers->getHL()) & 0x80) | (memory->read(registers->getHL()) >> 1)); registers->setZeroFlag(memory->read(registers->getHL()) == 0); registers->setSubFlag(false); registers->setHalfCarryFlag(false); lastClocks = 2; }
